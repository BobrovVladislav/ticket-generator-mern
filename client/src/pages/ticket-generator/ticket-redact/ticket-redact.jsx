import TicketControl from "../../../components/ticket-control/ticket-control";
    ...
    return (
        <div className="ticket-generator">
            ...
            <div className="ticket-redact">
                ...
                <div className="links">
                    <a id="link1" href="client/src/pages/ticket-generator/ticket-redact/ticket-redact#tab-2">
                        1</a>
                    <a id="link2" href="client/src/pages/ticket-generator/ticket-redact/ticket-redact#tab-1">
                        2</a>
                    <a id="link3" href="client/src/pages/ticket-generator/ticket-redact/ticket-redact#tab-3">
                        3</a>
